 ...
 * 
 */
public class CreateOrganizationWithRatingAsProjectCancelledTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*launch FirefoxBrowser*/
	       ...
	       /*Enter mandatory fields and select "Project Cancelled" from the dropdown in "Rating" field*/
	       driver.findElement(By.name("accountname")).sendKeys("Rspiders");
	       WebElement wb=driver.findElement(By.xpath("//select[@name='rating']"));
	       Select sel=new Select(wb);
	       sel.selectByVisibleText("Project Cancelled");
	       
	       /*validation*/
	       String exOption="Project Cancelled";
	       int i=0;
	       boolean flag=false;
